...
<template>
 <form class="userForm" id="userForm" @submit.prevent=loginUser>
  <input type="email" id="email" placeholder="Adresse e-mail" name="email" value="test@gmail.com" required>

  <div class="password-container">
    <input type="password" name="password" id="password" placeholder="Mot de passe" value="test" required>
    <button type="button" class="toggle-eye" @click.prevent=togglePassword aria-label="Afficher ou masquer le mot de passe">
...
.password-container input {
  flex: 1;
  padding: 14px;
  padding-right: 40px; /* місце для кнопки */
  border-radius: 12px;
  border: 1px solid #ccc;
  font-size: 1rem;
  background-color: #f5f5f5;
...
.toggle-eye {
  position: absolute;
  right: 10px; /* відступ від правого краю input */
  top: 50%;
