...
<template>
  <div class="c-tab-bar" v-show="users.tokenUser && !hidden">
    <!--Scénarios-->
    <RouterLink active-class="is-active" class="c-tab-bar__link" :to="{ name: 'scenarios-list' }"
      aria-label="Scénarios">
      <span class="material-symbols-outlined">format_list_bulleted</span>
    </RouterLink>
    <!--explore-map-->
    <RouterLink active-class="is-active" class="c-tab-bar__link" :to="{ name: 'explore-map' }"
      aria-label="Carte globale" @click="onClickMapGlobal">
      <span class="material-symbols-outlined">map</span>
    </RouterLink>
    <!--game-map-->
    <RouterLink active-class="is-active" class="c-tab-bar__link" :to="{ name: 'game-map' }"
      aria-label="Carte actuelle / position" @click="onClickMapCurrent">
      <span class="material-symbols-outlined">my_location</span>
    </RouterLink>
    <!--leaderboard-->
    <RouterLink active-class="is-active" class="c-tab-bar__link" to="/leaderboard" aria-label="Classement">
      <span class="material-symbols-outlined">emoji_events</span>
    </RouterLink>
    <!--user-profile-->
    <RouterLink active-class="is-active" class="c-tab-bar__link" to="/user-profile" aria-label="Profil utilisateur">
