  ...
  <div class="c-scenario-card" :class="[statusClass]" @click="handleSelect">
    <div class="c-scenario-card__media">
      <div class="c-scenario-card__thumb">
        <span class="material-symbols-outlined c-scenario-card__thumb-icon" aria-hidden="true"
          >menu_book</span
        >
      </div>
    </div>
    <div class="c-scenario-card__body">
      <div class="c-scenario-card__header">
        ...
        <button
          class="c-scenario-card__bookmark"
          :class="{ 'c-scenario-card__bookmark--active': scenario.bookmarked }"
          @click.stop="toggleBookmark"
          :title="scenario.bookmarked ? 'Retirer des favoris' : 'Ajouter aux favoris'"
          aria-label="Bookmark"
        >
          <span
            class="material-symbols-outlined c-scenario-card__bookmark-icon"
            :class="{ 'c-scenario-card__bookmark-icon--fill': scenario.bookmarked }"
            >{{ scenario.bookmarked ? 'bookmark' : 'bookmark' }}</span
          >
        </button>
      </div>
